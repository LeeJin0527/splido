...
// 4_12_2.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CMy4122App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMy4122App::OnAppAbout)
...
CMy4122App::CMy4122App() noexcept
{
	...
	SetAppID(_T("My4122.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CMy4122App 개체입니다.
...
BOOL CMy4122App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMy4122Doc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CMy4122View));
	if (!pDocTemplate)
		return FALSE;
